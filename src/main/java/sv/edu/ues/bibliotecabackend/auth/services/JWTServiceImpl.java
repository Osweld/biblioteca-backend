package sv.edu.ues.bibliotecabackend.auth.services;
...
import sv.edu.ues.bibliotecabackend.auth.mixin.SimpleGrantedAuthorityMixin;
...
public class JWTServiceImpl implements JWTService{
    ...
    public Claims getClaims(String token) {
        return Jwts.parserBuilder().setSigningKey(SECRET_KEY.getBytes()).build().parseClaimsJws(resolve(token)).getBody();
